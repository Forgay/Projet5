...
<nav class="white" role="navigation">
    <div class="nav-wrapper container">
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li><a href="../../web/index.php?action=write">Ajouter un article</a></li>
            <li><a href="../../web/index.php?action=list">liste des articles</a></li>
            <li><a href="../../web/index.php?action=logout">Se déconnecter</a></li>
        </ul>
